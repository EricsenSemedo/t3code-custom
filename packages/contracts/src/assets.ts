...
export const AssetResource = Schema.Union([
  ...
  Schema.TaggedStruct("preview-artifact", {
    path: TrimmedNonEmptyString.check(Schema.isMaxLength(ASSET_PATH_MAX_LENGTH)),
  }),
]);
...
export class AssetPreviewArtifactNotFoundError extends Schema.TaggedErrorClass<AssetPreviewArtifactNotFoundError>()(
  ...
  override get message(): string {
    return "Preview artifact was not found.";
  }
}

export class AssetPreviewArtifactInspectionError extends Schema.TaggedErrorClass<AssetPreviewArtifactInspectionError>()(
  ...
  override get message(): string {
    return "Failed to inspect the preview artifact.";
  }
}
